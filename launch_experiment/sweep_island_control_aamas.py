...
k_vector = linspace(k_start, k_end, 12)
# islandLeft is 15.3, islandRight is 26.52
num_offsets = 12
offset_start = 0
offset_end = (26.52 - 15.3)/3
...
root_directory += "sweep_k_" + str(k_start)[:4] + "_to_" + str(k_end)[:4] + "_offset_" + str(offset_start)[:4] + "_to_" + str(offset_end)[:4] + "/"
