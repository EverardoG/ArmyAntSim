...
public:
	Vterrain(b2World* world, config::sWindow windowParam,  config::sTerrain terrainParam, double bodyLength); // If want to define the dimension relatively to the body length
	virtual ~Vterrain();
