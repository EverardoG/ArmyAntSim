#ifndef TERRACETERRAIN_H_
#define TERRACETERRAIN_H_
...
class TerraceTerrain: public Terrain {
public:
	TerraceTerrain(	b2World* world, config::sWindow windowParam, config::sTerrain terrainParam, double bodyLength);
	virtual ~TerraceTerrain();
