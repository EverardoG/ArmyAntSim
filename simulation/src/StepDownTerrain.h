#ifndef STEPDOWNTERRAIN_H_
#define STEPDOWNTERRAIN_H_
...
class StepDownTerrain: public Terrain {
public:
	StepDownTerrain(	b2World* world, config::sWindow windowParam, config::sTerrain terrainParam, double bodyLength);
	virtual ~StepDownTerrain();
