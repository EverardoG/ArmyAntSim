...
#ifndef ISLANDTERRAIN_H_
#define ISLANDTERRAIN_H_
...
class IslandTerrain: public Terrain {
public:
	IslandTerrain(	b2World* world, config::sWindow windowParam, config::sTerrain terrainParam, double bodyLength);
	virtual ~IslandTerrain();
