...
TerraceTerrain::TerraceTerrain(b2World* world, config::sWindow windowParam, config::sTerrain terrainParam, double bodyLength)
...
TerraceTerrain::~TerraceTerrain() {
	// TODO Auto-generated destructor stub
}

void TerraceTerrain::createBody(b2World* world){
...
void TerraceTerrain::drawBody(sf::RenderWindow& window){
...
void TerraceTerrain::drawBody(sf::RenderTexture& texture){
	// std::cout << "for (Polygon polygon : allPolygons) {" << std::endl;
...
e_terrain_type TerraceTerrain::getType(){
	return ISLAND;
}
